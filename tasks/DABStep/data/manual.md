...
* If a field is set to empty list it means that it applies to all possible values of that field. E.g. empty list value in aci means that the rules applies for all possible values of aci.
